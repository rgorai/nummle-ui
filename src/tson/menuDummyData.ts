    ...
    items: [
      {
        ...
        name: 'Grilled Steak',
        price: 18.99,
        ingredients: ["Sirloin steak", "green beans", "mashed potatoes", "herbs"], 
        allergens: ["None"],
      ...
      },
      {
        ...
        price: 14.99,
        ingredients: ["Chicken", "green beans", "corn", "peas", "carrots", "herbs"],
        allergens: ["None"],
      ...
      },
      {
        ...
        price: 12.99,
        ingredients: ["Olive oil", "bell pepper", "snap peas", "mushrooms", "carrots", "broccoli", "sesame seeds", "soy sauce", "sesame oil"],
        allergens: ["Tree nuts"]
      },
      {
        id: 'main-course-5',
      ...
      },
      {
        ...
        name: 'Burger Deluxe',
        price: 11.99,
        ingredients: ["Beef", "tomato", "lettuce", "onion", "sesame seed bun", "french fries"],
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        id: 'dessert-3',
        name: 'Fruit Tart',
        ingredients: ["Strawberries", "blueberries", "blackberries", "vanilla custard", "shortbread"],
        allergens: ["Dairy", "Gluten"],
        price: 5.99,
      },
      {
      ...
      },
      {
        ...
        ingredients: ["Chocolate ice cream", "vanilla ice cream", "strawberry ice cream", "chocolate fudge", "whipped cream", "cherries"],
        allergens: ["Dairy"],
        price: 4.99,
        imagePath:
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        name: 'Greek Salad',
        price: 10.99,
        ingredients: ["Mixed greens", "olives", "feta cheese", "Greek dressing"],
        allergens: ["Dairy"],
      ...
      },
      {
        id: 'salad-3',
        name: 'Cobb Salad',
        ingredients: ["Lettuce", "bacon", "eggs", "chicken", "tomatoes"," blue cheese", "avocado"],
        allergens: ["Dairy"],
        price: 11.99,
        imagePath:
      ...
      },
      {
        ...
        price: 7.99,
        ingredients: ["Rice noodles", "carrots", "red peppers", "peanut butter", "tamari sauce", "sriracha", "ginger", "sugar", "garlic"],
        allergens: ["Peanuts"]
      },
    ],
  },
    ...
    items: [
      {
        id: 'sandwich-1',
        name: 'Club Sandwich',
        ingredients: ["Rye bread", "chicken", "bacon", "lettuce", "tomato", "mayo"],
        allergens: ["Dairy", "Gluten"],
        price: 11.99,
        description:
      ...
      },
      {
        id: 'sandwich-4',
        name: 'Veggie Wrap',
        ingredients: ["Flour tortilla", "spinach", "avocado", "carrot", "cucumber", "edamame"],
        allergens: ["Gluten"],
        price: 8.99,
        imagePath:
    ...
    items: [
      {
        id: 'soup-1',
        name: 'Tomato Soup',
        ingredients: ["Tomatoes", "onion", "garlic", "olive oil", "butter", "cream"],
        allergens: ["Dairy"],
        price: 4.99,
      ...
      },
      {
        id: 'soup-4',
        name: 'Lentil Soup',
        ingredients: ["Carrots", "peas", "celery", "parsley", "tomato", "pumpkin", "olive oil", "lentils"],
        allergens: ["None"],
        price: 4.49,
        imagePath:
      ...
      },
      {
        ...
        name: 'Clam Chowder',
        price: 6.49,
        ingredients: ["Clams", "cream", "carrots", "potatoes", "celery", "onion"],
